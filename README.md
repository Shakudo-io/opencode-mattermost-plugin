...
- **1.1.1** — First stable release. Hardened delegation access control (team membership required, early mention parsing), switched merge summarization to Gemini 3 Flash, comprehensive README with full usage examples for all features
- **0.3.96** — Version bump with delegation fixes merged from feature branch
